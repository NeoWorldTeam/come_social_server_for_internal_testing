...
let getUserCardList = function (userId) {
    ...
    if(!cardList){
        ...
        // 1 面具卡
        cardList.push({id:uuidv4(),name:"Blue Hair Boy",count:-1,type:1,coverURL: "res/img/mask_1/card_cover.png",backCoverURL: "res/img/mask_1/card_back_cover.png",ownerId:userId,params:[{name:"asseturl",value:"res/assetbundle/cs_male_white.zip"}]})
        cardList.push({id:uuidv4(),name:"Blond Girl",count:-1,type:1,coverURL: "res/img/mask_2/card_cover.png",backCoverURL: "res/img/mask_2/card_back_cover.png",ownerId:userId,params:[{name:"asseturl",value:"res/assetbundle/cs_female.zip"}]})
        cardList.push({id:uuidv4(),name:"African Style",count:-1,type:1,coverURL: "res/img/mask_3/card_cover.png",backCoverURL: "res/img/mask_3/card_back_cover.png",ownerId:userId,params:[{name:"asseturl",value:"res/assetbundle/cs_male_black.zip"}]})
        cardList.push({id:uuidv4(),name:"Smirky Cat",count:-1,type:1,coverURL: "res/img/mask_4/card_cover.png",backCoverURL: "res/img/mask_4/card_back_cover.png",ownerId:userId,params:[{name:"asseturl",value:"res/assetbundle/face_cat_mod_101.zip"}]})
        // 2 Party卡
